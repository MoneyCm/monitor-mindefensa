...
class Notifier:
    ...
    def _generar_html(self, resumen, tipo_run, pdf_sha):
        ...
        titulo = f"{asunto_prefijo} - Observatorio Jamundí"
        ...
        <body style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f4f4f8; margin: 0; padding: 20px;">
            <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                ...
                <div style="padding: 30px;">
                    <p style="color: #444; font-size: 15px; line-height: 1.6;">Cordial saludo,<br><br>Se adjunta el <b>Boletín de Seguridad Institucional</b> con el análisis consolidado de las últimas actualizaciones de MinDefensa.</p>
    ...
    def enviar(self, pdf_path, tipo_run="normal"):
        ...
        msg = MIMEMultipart()
        msg['Subject'] = f"{prefijo} - {datetime.now().strftime('%d/%m/%Y')}"
        msg['From'] = self.user
